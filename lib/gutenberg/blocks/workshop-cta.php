...
<div class="workshop-card white-bg container">
    ...
    if ($date_now > $workshop_date) :
        echo '<h2>Find out more about future workshops</h2>';
        echo '<p>Register your interest now and we will let you know when we announce our next workshop</p>';
    ?>
        <button class="button popmake-post-<?php echo $new_popup_id; ?>">Register your interest</button>
        <?php echo do_shortcode("[popup id='post-" . $new_popup_id . "']" .
            $shortcode_data .
            "[/popup]"); ?>
</div>
<?php else :
