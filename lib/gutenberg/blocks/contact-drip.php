    ...
    <div class="half-width container form-container inner-container contact-form-container">
        <div class="form">
            <form action="https://www.getdrip.com/forms/232834888/submissions" method="post" data-drip-embedded-form="232834888" id="drip-form">
                ...
                <div class="form-disclaimer"><?php if($disclaimer): echo $disclaimer; endif; ?></div>
                
                <div class="form-fields"> 
                    <input id="button" class="button medium g-recaptcha" type="submit" value="Send" data-drip-attribute="sign-up-button" data-sitekey="6LdNwPwUAAAAAO-vpaPRgT8gOh2gen3Dyd-1eSNT" data-callback='onSubmit'>
                </div>
                </form>
        </div>
    </div>
